    ...
    return(
        <div>
            <div className="absolute w-screen h-screen flex justify-center items-center shadow-2xl z-10 gap-24 flex-col text-2xl md:text-5xl font-sans font-black text-center">
                <input className="border-8 border-white text-center" type="text" placeholder="unesite ovde svoj jmbg" required></input>
                <button className="border-4 border-black bg-green-100 pl-6 pr-6 leading-loose " type="button">Potvrdi</button>
            </div>
